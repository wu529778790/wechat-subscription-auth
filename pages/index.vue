    ...
    <div
      ...
      <div class="space-y-3 text-left text-sm bg-[#F8F8F8] p-4 rounded-xl mb-6">
        <div class="flex items-start gap-2">
          <span class="font-bold text-[#07C160] whitespace-nowrap w-16 text-right">API:</span>
          <span class="text-gray-600 break-all">{{ API_BASE }}</span>
        </div>
        <div class="flex items-start gap-2">
          <span class="font-bold text-[#07C160] whitespace-nowrap w-16 text-right">公众号:</span>
          <span class="text-gray-600">{{ WECHAT_NAME }}</span>
        </div>
        <div v-if="WECHAT_QRCODE_URL" class="flex items-start gap-2">
          <span class="font-bold text-[#07C160] whitespace-nowrap w-16 text-right">二维码:</span>
